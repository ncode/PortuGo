...
and formatted replay coverage. Four generated-data transcripts remain pending
...
A replay audit of the eight remaining pending accepted programs found no
...
the mixed integer/text, integer-sort, real-sort, record-sort, and integer-search
transcripts now have reviewed shape-specific contracts. Seven generated-output
...
expectations: all eight remaining recordings are accepted by the reference. The
...
expected output remain unchanged, and all eight remain pending.
