...
Fourteen previously pending probes now have focused implementation tests and
...
digits are removed or rewritten. This qualifies the four listed timer/clock
...
stdout, clock schedules and host traces for all seven qualified chronometer
programs.
