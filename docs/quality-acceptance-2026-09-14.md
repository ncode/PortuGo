...
do not establish implementation acceptance: 13 implementation probes remain
...
| --- | ---: | --- |
| Bundled example qualification (17.3) | 13 | See the manifest for the current pending probe inventory. |
...
Seven bundled transcripts now have verified generated-output contracts. One
...
code/name records with both sort orders. All replay the original and formatted
