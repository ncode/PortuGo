...
do not establish implementation acceptance: 18 implementation probes remain
...
| --- | ---: | --- |
| Bundled example qualification (17.3) | 18 | See the manifest for the current pending probe inventory. |
...
Two bundled transcripts now have verified generated-output contracts. One
...
lines. Both replay the original and formatted source without comparing random
sequences. The remaining generated-output cases and rejected paths stay
pending.
