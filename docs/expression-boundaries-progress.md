...
suffixes, and mixed arithmetic/logical reductions. Twelve match the implementation
and have regression tests; four value-reduction cases remain pending.
...
The remaining cases concern value propagation when arithmetic consumes an `e`
...
`7`. Their original outputs and diagnostics are recorded, and their implementation
states stay pending. This slice does not claim complete expression conformance.
