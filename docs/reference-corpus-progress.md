...
manifest has 1,657 recorded probes and 22 reviewed non-applicable probes; 20
...
reviewed not-applicable probes, and no unrecorded entries. The 20 pending
...
keeps the current 20 pending implementation probes visible; the two recorded
